...
<body>
    ...
    <div class="content">
        <div class="informacion">
            <p></p>&nbsp
            <h1>MODIFICAR EL EL PRÉSTAMO</h1><br/>
            <form action="editar_prestamo.php" method="POST" enctype="multipart/form-data">
            ...
            ?>"/><br/>
                ...
                <div class="fila">
                    ...
                    <input type="date" REQUIRED name="devolucion" readonly autocomplete="off" value="<?php echo $row['fecha_devolucion']?>"/><br/>
                </div>
                <div class="fila">
                    <label>NOTAS</label>
