...
<body>
    ...
    <div class="informacion">
            <p></p>&nbsp
        <h1>REGISTRAR AL LECTOR EN SALA</h1><br/>
        <form action="registrar_lectura.php" method="POST" enctype="multipart/form-data">
    ...
    ?>
                ...
                <div class="fila">
                    <label>C.I.</label>
                    <input type="int" REQUIRED name="ci" autocomplete="off" value=""/><br/><br/>
                </div>
                <div class="fila">
                    <label>NOMBRES</label>
                    <input type="text" REQUIRED name="nombre" autocomplete="off" value=""/><br/><br/>
                </div>
                <div class="fila">
                    <label>APELLIDOS</label>
                    <input type="text" REQUIRED name="apellido" autocomplete="off" value=""/><br/><br/>
                </div>
                <div class="fila">
