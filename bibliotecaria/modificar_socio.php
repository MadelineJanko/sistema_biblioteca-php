    ...
    <div class="informacion">
        ...
        <form action="registrar_socioconfirmado.php" method="POST" enctype="multipart/form-data">
            <div class="contenedorlibro">
                ...
                <div class="fila">
                    <label>NOMBRES</label>
                    <input type="text" REQUIRED name="nombre" autocomplete="off" value="<?php echo $row['nombre']?>"/><br/>
                </div>
                <div class="fila">
                    <label>APELLIDOS</label>
                    <input type="text" REQUIRED name="apellido"autocomplete="off" value="<?php echo $row['apellido']?>"/><br/>
                </div>
                <div class="fila">
                    <label>C.I.</label>
                    <input type="number" REQUIRED name="ci" onkeypress="return numeros(event)" autocomplete="off" value="<?php echo $row['ci']?>"/><br/>
                </div>
                <div class="fila">
                    <label>EMAIL</label>
                    <input type="text" REQUIRED name="email" autocomplete="off" value="<?php echo $row['email']?>"/><br/>
                </div>
                <div class="fila">
                    <label>PASSWORD</label>
                    <input type="int" REQUIRED name="pass" autocomplete="off" value="<?php echo $row['pass']?>"/><br/>
                </div>
                <div class="fila">
                    <label>DIRECCIÓN</label>
                    <input type="text" REQUIRED name="direccion" autocomplete="off" value="<?php
                    if(isset($row['id']))
                    {
                        $dato_final="";
                ...
                <div class="fila">
                    ...
                    <input type="int" REQUIRED name="telefono" autocomplete="off" value="<?php
                    if(isset($row['id']))
                    {
                        $dato_final="";
                        $inc = require_once("../conexion.php");
